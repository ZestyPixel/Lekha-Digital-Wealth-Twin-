      ...
      <div className="box">
        ...
        <form className="login-box" onSubmit={formik.handleSubmit}>
          <div className="form-group">
            <label htmlFor="monthlyIncome" className="email-and-password">
              Monthly Income:
            </label>
            <input
              id="monthlyIncome"
          ...
          <div className="form-group">
            <label htmlFor="number" className="email-and-password">
              Number:
            </label>
            <input
              id="number"
          ...
          <div className="form-group">
            <label htmlFor="emergencyEmail" className="email-and-password">
              Emergency Email:
            </label>
            <input
              id="emergencyEmail"
            ...
            {formik.errors.emergencyEmail && (
              <div className="error">{formik.errors.emergencyEmail}</div>
            )}
          </div>

          <div className="form-group">
            <label htmlFor="emergencyNumber" className="email-and-password">
              Emergency Number:
            </label>
            <input
              id="emergencyNumber"
            ...
            {formik.errors.emergencyNumber && (
              <div className="error">{formik.errors.emergencyNumber}</div>
            )}
          </div>

          <div className="form-group">
            <label htmlFor="age" className="email-and-password">
              Age:
            </label>
            <input
              id="age"
          ...
          <div className="form-group">
            <label htmlFor="riskProfile" className="email-and-password">
              Risk Profile:{" "}
            </label>
            <select
              id="riskProfile"
          ...
          <div className="form-group">
            <label htmlFor="bills" className="email-and-password">
              Bills Budget:
            </label>
            <input
              id="bills"
            ...
            />
            {formik.errors.bills && (
              <div className="error">{formik.errors.bills}</div>
            )}
          </div>

          <div className="form-group">
            <label htmlFor="food" className="email-and-password">
              Food Budget:
            </label>
            <input
              id="food"
            ...
            />
            {formik.errors.food && (
              <div className="error">{formik.errors.food}</div>
            )}
          </div>

          <div className="form-group">
            <label htmlFor="health" className="email-and-password">
              Health Budget:
            </label>
            <input
              id="health"
            ...
            {formik.errors.health && (
              <div className="error">{formik.errors.health}</div>
            )}
          </div>

          <div className="form-group">
            <label htmlFor="lifestyle" className="email-and-password">
              Lifestyle Budget:
            </label>
            <input
              id="lifestyle"
            ...
            {formik.errors.lifestyle && (
              <div className="error">{formik.errors.lifestyle}</div>
            )}
          </div>

          <div className="form-group">
            <label htmlFor="obligations" className="email-and-password">
              Obligations Budget:
            </label>
            <input
              id="obligations"
            ...
            {formik.errors.obligations && (
              <div className="error">{formik.errors.obligations}</div>
            )}
          </div>
          ...
          <div className="form-group">
            <label htmlFor="misc" className="email-and-password">
              Misc Budget:
            </label>
            <input
              id="misc"
