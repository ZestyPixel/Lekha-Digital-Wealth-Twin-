      ...
      <div className="card-container">
        {protectedData.goal.map((point) => (
          <GoalCard
            ...
            Progress={Math.round(
              (point.currentProgress / point.targetAmount) * 100,
            )}
      ...
      <div className="box">
        ...
        <form className="login-box" onSubmit={formik.handleSubmit}>
          <div className="form-group">
            <label htmlFor="goalName" className="email-and-password">
              Goal Name:
            </label>
            <input
              id="goalName"
          ...
          <div className="form-group">
            <label htmlFor="targetAmount" className="email-and-password">
              Target Amount:
            </label>
            <input
              id="targetAmount"
          ...
          <div className="form-group">
            <label htmlFor="currentProgress" className="email-and-password">
              Current Saved:
            </label>
            <input
              id="currentProgress"
          ...
          <div className="form-group">
            <label htmlFor="targetDate" className="email-and-password">
              Target Date:
            </label>
            <input
              id="targetDate"
          ...
          <div className="form-group">
            <label htmlFor="priority" className="email-and-password">
              Priority Level:
            </label>
            <select
              id="priority"
