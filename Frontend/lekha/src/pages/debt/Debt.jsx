            ...
            <div className="card-container">
                {protectedData.debt.map((item) => (
                    <DebtCard
                        ...
                        EMI={item.monthlyEMI}
                        Progress={Math.round(((item.totalAmount - item.remainingBalance) / item.totalAmount) * 100)}
                    />
                ))}
            </div>
            ...
            <div className="box">
                ...
                <form className="login-box" onSubmit={formik.handleSubmit}>
                    ...
                    <div className="form-group">
                        <label htmlFor="debtName" className="email-and-password">Debt Name:</label>
                        <input
                            id="debtName"
                            name="debtName"
                            className="email-bar"
                            type="text"
                            placeholder="Ex: Home Loan, Car Loan, Credit Card"
                    ...
                    <div className="form-group">
                        <label htmlFor="totalAmount" className="email-and-password">Total Amount:</label>
                        <input
                            id="totalAmount"
                            name="totalAmount"
                            className="email-bar"
                    ...
                    <div className="form-group">
                        <label htmlFor="remainingBalance" className="email-and-password">Remaining Balance:</label>
                        <input
                            id="remainingBalance"
                        ...
                        />
                        {formik.touched.remainingBalance && formik.errors.remainingBalance ? (
                            <div className="error">{formik.errors.remainingBalance}</div>
                        ) : null}
                    </div>

                    <div className="form-group">
                        <label htmlFor="monthlyEMI" className="email-and-password">Monthly EMI:</label>
                        <input
                            id="monthlyEMI"
                            name="monthlyEMI"
                            className="email-bar"
                    ...
                    <button type="submit" className="sign-up">Add Debt</button>
