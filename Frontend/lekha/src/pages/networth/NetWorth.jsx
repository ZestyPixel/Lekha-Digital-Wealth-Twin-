...
export default function AddAssetForm() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      //What setSubmitting does is it sets the form to a "submitting" state,
      ...
      <div className="box">
        ...
        <form className="login-box" onSubmit={formik.handleSubmit}>
          <div className="form-group">
            <label htmlFor="type" className="email-and-password">
              Asset Type:
            </label>
            <input
              id="type"
          ...
          <div className="form-group">
            <label htmlFor="currentValue" className="email-and-password">
              Asset Value:
            </label>
            <input
              id="currentValue"
            ...
            {formik.errors.currentValue && (
              <div className="error">{formik.errors.currentValue}</div>
            )}
          </div>

          <div className="form-group">
            <label htmlFor="institution" className="email-and-password">
              Holding Institution:
            </label>
            <input
              id="institution"
